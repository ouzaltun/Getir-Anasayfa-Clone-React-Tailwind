    ...
    <div className="bg-primary-brand-color px-11">
      <div className="container mx-auto md:h-12 h-16 flex items-center justify-center md:justify-between">
        <div className="flex items-center gap-x-8">
          <a
            href="#"
            className="text-white text-opacity-80 font-semibold justify-center align-middle"
          >
            <img
          ...
          <a
            href=""
            className="text-white text-xl  text-opacity-80 font-semibold max-md:hidden"
          >
            getiryemek
          </a>
        </div>
